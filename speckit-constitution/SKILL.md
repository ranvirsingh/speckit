...
description: >-
  ...
  changing governance principles, adding or removing MUST/SHOULD rules, updating versioning
  policy, or when the user mentions "constitution", "principles", or "governance".
---

## Next Steps

After updating the constitution, the user may want to create a feature specification.
Suggest: **speckit-specify** — "Build a feature specification based on the updated constitution."
...
1. Load the existing constitution at `docs/constitution.md`.
...
7. Write the completed constitution back to `docs/constitution.md` (overwrite).
