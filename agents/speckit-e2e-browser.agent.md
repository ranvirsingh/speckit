...
> 1. **DO NOT write application code.** Your write scope is e2e test artifacts ONLY (under `e2e/`, `tests/e2e/`, `screenshots/`, `gifs/`, `test-results/`). Modifying `src/` to make tests pass is a protocol violation the parent will reject.
